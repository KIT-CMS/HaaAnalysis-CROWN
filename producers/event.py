...
RunLumiEventFilter = VectorProducer(
    ...
    call='event::filter::Quantity<{RunLumiEventFilter_Quantity_Types}>({df}, "EventFilter", "{EventFilter_Quantity}", {vec_open}{EventFilter_Selections}{vec_close})'
    '({df}, "{RunLumiEventFilter_Quantities}", {vec_open}{RunLumiEventFilter_Selections}{vec_close}, "RunLumiEventFilter")',
    input=[],
    output=None,
    scopes=["global"],
    vec_configs=[

...
# this file is currently unused in the Haa analysis configuration, some producers might be deprecated
####################

BuildMetVector = Producer(
    name="BuildMetVector",
    call="lorentzvectors::buildMet({df}, {output}, {input})",
    input=[
        nanoAOD.MET_pt,
        nanoAOD.MET_phi,
    ],
...
PropagateLeptonsToMet = Producer(
    ...
    call="met::propagateLeptonsToMet({df}, {output}, {input}, {propagateLeptons})",
...
PropagateJetsToMet = Producer(
    ...
    call="met::propagateJetsToMet({df}, {output}, {input}, {propagateJets}, {min_jetpt_met_propagation})",
    input=[
...
ApplyRecoilCorrections = Producer(
    ...
    call='met::applyRecoilCorrections({df}, {output}, {input}, "{recoil_corrections_file}", "{recoil_systematics_file}", {applyRecoilCorrections}, {apply_recoil_resolution_systematic}, {apply_recoil_response_systematic}, {recoil_systematic_shift_up}, {recoil_systematic_shift_down}, {is_wjets})',
    input=[

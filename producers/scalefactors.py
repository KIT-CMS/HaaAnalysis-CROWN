...
Muon_1_ID_SF_RooWorkspace = Producer(
    ...
    call='scalefactor::muon::id_rooworkspace({df}, {output}, {input}, "{muon_sf_workspace}", "{muon_sf_id_name}", "{muon_sf_id_args}")',
...
Muon_1_Iso_SF_RooWorkspace = Producer(
    ...
    call='scalefactor::muon::iso_rooworkspace({df}, {output}, {input}, "{muon_sf_workspace}", "{muon_sf_iso_name}", "{muon_sf_iso_args}")',
...
Muon_1_Trigger_SF = Producer(
    name="MuonTrigger_SF",
    call='physicsobject::muon::scalefactor::Trigger({df}, correctionManager, {output}, {input}, "{muon_sf_file}", "{muon_trigger_sf_name}", "{muon_sf_varation}")',
    input=[q.pt_1, q.eta_1],

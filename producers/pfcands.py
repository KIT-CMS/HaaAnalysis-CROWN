...
pfCandpdgId = Producer(
    name="PFCandsPdgId",
    call="basefunctions::rename<ROOT::RVec<Int_t>>({df}, {output}, {input})",
...
pfCandpt = Producer(
    name="PFCandspt",
    call="basefunctions::rename<ROOT::RVec<Float_t>>({df}, {output}, {input})",
...
ChargedPFCandsPdgId = Producer(
    name="PFCandsPdgId",
    call="physicsobject::CutQuantity<int>({df}, {output}, {input}, {vec_open}{pfcands_pdgid}{vec_close})",
    input=[nanoAOD.PFCands_pdgId],
    output=[],
    scopes=["global"],
)                                                                                                                                
PFCandsPtCut = Producer(
    name="PFCandsPtCut",
    call="physicsobject::CutMin<float>({df}, {output}, {input}, {min_pfcands_pt})",
    input=[nanoAOD.PFCands_pt],
    output=[],
    scopes=["global"],
)
PFCandsEtaCut = Producer(
    name="PFCandsEtaCut",
    call="physicsobject::CutAbsMax<float>({df}, {output}, {input}, {max_pfcands_eta})",
    input=[nanoAOD.PFCands_eta],
    output=[],
    scopes=["global"],
)
...
PFCandsMinMassCut = Producer(
    name="PFCandsMassCut",
    call="physicsobject::CutMin<float>({df}, {output}, {input}, {min_pfcands_mass})",
    input=[nanoAOD.PFCands_mass],
    output=[],
    scopes=["global"],
)
...
PFCandsMaxMassCut = Producer(
    name="PFCandsMassCut",
    call="physicsobject::CutMax<float>({df}, {output}, {input}, {max_pfcands_mass})",
    input=[nanoAOD.PFCands_mass],
    output=[],
    scopes=["global"],
)
...
PFCandsFromPVSelection = Producer(
    ...
    call="physicsobject::CutQuantity<int>({df}, {output}, {input}, {vec_open}{pfcands_fromPV_flag}{vec_close})",
...
ChargedPFCands = Producer(
    name="ChargedPFCands",
    call="physicsobject::CutQuantity<int>({df}, {output}, {input}, {vec_open}{charged_pfcands_pdgid}{vec_close})",
    input=[nanoAOD.PFCands_pdgId],
...
NeutralPFCands = Producer(
    name="NeutralPFCands",
    call="physicsobject::CutQuantity<int>({df}, {output}, {input}, {vec_open}{neutral_pfcands_pdgid}{vec_close})",
    input=[nanoAOD.PFCands_pdgId],
...
PhotonPFCands = Producer(
    name="PhotonPFCands",
    call="physicsobject::CutQuantity<int>({df}, {output}, {input}, {vec_open}{photon_pfcands_pdgid}{vec_close})",
    input=[nanoAOD.PFCands_pdgId],
...
fromPV = Producer(
    name="PFCands_fromPV",
    call="physicsobject::CutQuantity<int>({df}, {output}, {input}, {vec_open}{fromPV}{vec_close})",
    input=[nanoAOD.PFCands_fromPV],
    output=[q.fromPV],
    scopes=["global"],
)
...
GenPartPdgId = Producer(
    name="GenPartPdgId",
    call="physicsobject::CutQuantity<int>({df}, {output}, {input}, {vec_open}{genpart_pdgid}{vec_close})",
...
GenPartStatus = Producer(
    name="GenPartStatus",
    call="physicsobject::CutQuantity<int>({df}, {output}, {input}, {vec_open}{genpart_status}{vec_close})",
...
z_pt = Producer(
    name="z_pt",
    call="haa::getGenPt({df}, {output}, {input})",

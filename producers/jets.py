...
JetPtCut = Producer(
    name="JetPtCut",
    call="physicsobject::CutPt({df}, {output}, {input}, {min_jet_pt})",
    input=[nanoAOD.Jet_pt],
    output=[],
    scopes=["global"],
)
BJetPtCut = Producer(
    name="BJetPtCut",
    call="physicsobject::CutPt({df}, {output}, {input}, {min_bjet_pt})",
    input=[nanoAOD.Jet_pt],
    output=[],
    scopes=["global"],
)
JetEtaCut = Producer(
    name="JetEtaCut",
    call="physicsobject::CutEta({df}, {output}, {input}, {max_jet_eta})",
...
BJetEtaCut = Producer(
    name="BJetEtaCut",
    call="physicsobject::CutEta({df}, {output}, {input}, {max_bjet_eta})",
    input=[nanoAOD.Jet_eta],
    output=[],
    scopes=["global"],
)
...
BTagCut = Producer(
    name="BTagCut",
    call="physicsobject::jet::AntiCutRawID({df}, {output}, {input}, {btag_cut})",
